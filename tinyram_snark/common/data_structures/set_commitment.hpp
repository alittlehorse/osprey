...
#include <tinyram_snark/gadgetlib1/gadgets/hashes/hash_io.hpp> // TODO: the current structure is suboptimal
...
#include <tinyram_snark/common/data_structures/set_commitment.tcc>
